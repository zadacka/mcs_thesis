...
There are no standardised formats for storing raw connectome data, as the form of the data depends on the experimental technique used to obtain it (EM, OM, DT-MRI) and the specific equipment used. Fortunately, HCP do standardise their data, as well as de-noising and normalising it.
