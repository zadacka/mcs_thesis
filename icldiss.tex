...
As mentioned in Chapter 2, the project had a particular interest in the tractography connectome representation. With this in mind, new tractographies were generated from CIFTI connectome data, and saved in vtk format for display on the Rift. 

CAMINO kept having memory issues until I gave it TEN GIGABYTES of RAM. Good thing that I've got my own PC with 12...
