...
There are no standardised formats for storing connectome data, and the form of raw data depends on the experimental technique used to obtain it (EM, OM, DT-MRI) and the specific equipment used. Many tools such as NeuroneJ \cite{NeuronJ2014}, Imaris \cite{Imaris2014}, and Amia \cite{Amira2014} exist for manipulating connectome data in 2D and 3D but these tools can require data to be processed into a specific input format.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{resources/tractography}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{resources/tuboids}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{resources/hybrid_glyphs}
    \caption{Hybrid glyphs used to represent local diffusivity in DT-MRI data. \cite{Westin2002}}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{resources/glyph_packing}
...
\begin{figure}[htbp]
    ...
    \caption{Left: network structure and right: interconnection density maps. \cite{Hagmann2005}}
